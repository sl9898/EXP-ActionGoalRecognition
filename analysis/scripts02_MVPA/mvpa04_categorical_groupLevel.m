...
path_cont = ['../output.Categorical_contrast_sm3_9conds_BVmask00'];
...
path_group = sprintf('../output.MvpaGLM_Group_sm3_9conds_BVmask00_N%0.2d', length(subvec));

spm('Defaults','fMRI'); 
spm_jobman('initcfg');
curpath = pwd();

for ic = 1:2 % ncont (single cond vs basedline after 9)
    clear matlabbatch
